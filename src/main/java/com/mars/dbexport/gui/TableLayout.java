...
public class TableLayout implements LayoutManager2, VTabLayoutConstants {
    // ******************************************************************************
    // *** Inner Class ***
    // ******************************************************************************
    // The following inner class is used to bind components to their constraints
    protected class Entry extends VTabLayoutConstraints {
     ...
     *            col1, col2, ..., colN}�п�����, {row0, row1, row2, ..., rowM}�п�����}
     *            If this parameter is invalid, the VTabLayout will have exactly
     *            one row and one column. <br>
     *            ����: <br>
     *            new double[][]{ {5,20,TableLayout.FILL,5},{5,TableLayout.FILL}
     *            } <br>
     *            4��2�еı�� <br>
     *            ��һ�п�5���أ���2��20���أ���3�и��������С�Զ���䣬��4��5������ <br>
     *            ��1��5���أ���2���Զ����� <br>
     * <br>
     *            ��ע�����е���Ŵ�0��ʼ������2��ʾ�ǵ�3��/�� <br>
     * <br>
     *            �����η������У� <br>
     *            panel.add(ipAddrTextField, "1,1,3,f"); //2�У�2�У��п�2-4�У������� <br>
     * <br>
     *            ���⣬�����ĸ�������˱�ʾ�缸�����⣬���滹�ж��뷽ʽ�����У�l(eft),r(ight),c(enter),f(ill-
     *            ��䣩�����У�t(op),b(ottom),c(enter),f(ill)
     */
